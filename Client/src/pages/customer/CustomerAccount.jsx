...
const CustomerAccount = () => {
    ...
    const fetchCustomer = async () => {
        try {
            const res = await axios.get("/customer/my-profile", { 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put("/customer/update", formData, { withCredentials: true });
    ...
    const fullName = `${customer.userId.firstname} ${customer.userId.middlename || ""} ${customer.userId.lastname}`.trim();
